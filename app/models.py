...
from sqlalchemy import JSON, Boolean, Date, DateTime, Enum as SQLEnum, ForeignKey, Integer, LargeBinary, String
...
class PatientJsonFile(Base):
    __tablename__ = "patient_json_files"
